...
export const metadata: Metadata = {
  title: "About - Symuality",
  description:
    "The story behind Symuality, a faith journal by Ryan Dalton.",
};
    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950">
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        <article className="prose prose-zinc dark:prose-invert max-w-none">
          ...
          <p className="not-prose text-lg italic text-zinc-500 dark:text-zinc-400">
            sim-you-al-ity
          </p>

          <h2>Behind the Web</h2>
          <p>
            If you absolutely must know the man behind the mask, my name is
            Ryan Dalton. I&apos;m a full-time software engineer building a
            ...
            more about my professional experiences, please feel free to check
            out my{" "}
            <a
          ...
          <h2>The Site</h2>
          <p>
            I don&apos;t have a master plan for this website. It is currently
            February 2026 and I&apos;m going to try to document my Bible study.
            Maybe this morphs into more. Going forward, I&apos;m excited to
            uphold a more Christian lifestyle that includes being a better
            husband, father, and faith-with-fire follower of Jesus Christ.
          </p>
          ...
          <blockquote>
            ...
            <footer className="not-prose mt-2 text-sm text-zinc-500 dark:text-zinc-400">
